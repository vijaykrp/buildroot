...
WPEFRAMEWORK_PLUGINS_VERSION = b809f3f4b3bb0aabf8e5f291fd7e46ff54da34b9
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DCMAKE_C_FLAGS_RELEASE="-DLINUX -DEGL_API_FB" \
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_AMPSAMPLES=ON
endif

WPEFRAMEWORK_PLUGINS_PKGDIR = "$(TOP_DIR)/package/wpe/wpeframework-plugins"
define WPEFRAMEWORK_PLUGINS_APPLY_LOCAL_PATCHES
        $(APPLY_PATCHES) $(@D) $(WPEFRAMEWORK_PLUGINS_PKGDIR) 0001-ampsamples.patch.conditional;
endef
ifeq ($(BR2_PACKAGE_MARVELL_AMPSDK),y)
WPEFRAMEWORK_PLUGINS_POST_PATCH_HOOKS += WPEFRAMEWORK_PLUGINS_APPLY_LOCAL_PATCHES
endif
